...
with DAG(
    ...
    def save_data_to_mongodb(records):
        ...
        collection = db["user_coll_seymauzun"]
    ...
    #schedule.every(1).minutes.do(create_sample_data_on_mongodb)
    ...
    def copy_anomalies_into_new_collection():
        ...
        db = client["bigdata_training"]
        coll1 = db["user_coll_seymauzun"]
        coll2 = db["anomalies_seymauzun"]
